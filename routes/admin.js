...
router.post("/bank", uploadSingle, adminController.addBank); // sebelum ke add bank di ngecheck ke middleware bank
...
router.delete("/item/:itemId/feature/:id", adminController.delelteFeature);
...
router.delete("/item/:itemId/activity/:id", adminController.delelteActivity);
